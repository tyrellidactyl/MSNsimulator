...
cMap1 = load("/home/ty/MSNsimulator/TestResults/PlumeCases/Case" + num2str(plumecase) + ...
    "/Test" + num2str(testcase) + "/APScase" + num2str(plumecase) + ...
    "test" + num2str(testcase) + "trial1N8" + "metric" + num2str(1) + "cMap.mat");
cMap2 = load("/home/ty/MSNsimulator/TestResults/PlumeCases/Case" + num2str(plumecase) + ...
    "/Test" + num2str(testcase) + "/APScase" + num2str(plumecase) + ...
    "test" + num2str(testcase) + "trial1N8" + "metric" + num2str(2) + "cMap.mat");
cMap3 = load("/home/ty/MSNsimulator/TestResults/PlumeCases/Case" + num2str(plumecase) + ...
    "/Test" + num2str(testcase) + "/APScase" + num2str(plumecase) + ...
    "test" + num2str(testcase) + "trial1N8" + "metric" + num2str(3) + "cMap.mat");
...
%labels = reordercats(labels,{'M5','M0','M6','M7'});
...
maptitle = "Concentration Map Occupancy Scan Comparison (Expansion Metric): " + str;
title(maptitle)
...
fig1 = path + str + 'ConcMapScanMetricsComparison1.png';
saveas(f,fig1);
