...
% Create coordinate arrays to display waypoint objectives
xp = [0 0 0 5 -5];
yp = [5 -5 0 0 0];

b = [0,5; 0,-5; 0,0; 5,0; -5,0]; % waypoint coordinates
...
t = 60; % time (seconds) to record velocity
